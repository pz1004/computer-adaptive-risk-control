...
\uppercase{Siyeon Park}\authorrefmark{2},
...
Daejeon 34158, Republic of Korea (e-mail: worksiyeon@gmail.com; ahyun@hanbat.ac.kr)}
...
\begin{keywords}
Adaptive inference, calibration, early-exit networks, finite-sample guarantees, model cascades, risk control.
\end{keywords}
...
\begin{figure}[t]
\centering
\includegraphics[width=.92\linewidth]{figures/fig2_chain_band.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/fig3_empirical_summary.png}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/Park.png}}]{Siyeon Park} received the B.S. degree in intelligent media engineering from Hanbat National University, Daejeon, South Korea, in 2026. He is currently pursuing the M.S. degree in intelligent media engineering at Hanbat National University, Daejeon, South Korea.
From 2025 to 2026, he was a Research Intern for four months with the Hyper-Reality Metaverse Research Laboratory, Electronics and Telecommunications Research Institute (ETRI), Daejeon, South Korea. His research interests include computer vision, 3D graphics, and digital twins. 
\end{IEEEbiography}
